...
public class AwsPolicyCreator extends AwsService {
    ...
    try {
      ...
      CreatePolicyRequest policyRequest =
          CreatePolicyRequest.builder()
              .policyName("MyOwnPolicy")
              .policyDocument(policyJson)
              .description(
                  "This policy was created as part of AWS Udemy course from my local machine through AWS Java SDK")
              .build();
      CreatePolicyResponse createPolicyResponse = iamCLient.createPolicy(policyRequest);
      System.out.println(
          "Custom policy is created with ARN: " + createPolicyResponse.policy().arn());
